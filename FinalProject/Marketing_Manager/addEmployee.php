...
<?php 
	...
	require_once "php_validation/addEmployee_validation.php";
	...
	<body>
		...
		<form action="" onsubmit="return validate()" method="post">
				...
				<tr>
					...
					<td><input type="text" value="<?php echo $eid ?>" id="eid" name="eid">
						<span><?php echo $err_eid; ?></span>
						<span id="err_eid"></span>
					</td>
				</tr>
				<tr>
